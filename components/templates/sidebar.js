...
export default function Sidebar({ flagSide }) {
  return (
    <div className={flagSide ? "sideActive" : "sideDeActive"}>
      <div className="w-full flex flex-col gap-5">
        <div className="sideItemDeActive active:sideItemActive">
          ...
          <span className="font-medium text-[1.7rem]">Posts</span>
        </div>
        <div className="sideItemDeActive active:sideItemActive">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="font-medium text-[1.7rem]">Comments</span>
        </div>
        <div className="sideItemDeActive active:sideItemActive">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="sideItemDeActive active:sideItemActive">
          ...
          <span className="font-medium text-[1.7rem]">heart</span>
        </div>
      </div>
